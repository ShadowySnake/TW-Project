...
async function questionGetter(){
    ...
    if(sessionStorage.getItem('questionsAnswered') == null) item.innerText = "Press the 'Done' button!";
            ...
            let URL = "http://localhost/TW-Project/api/answers/getanswers";
...
checker.addEventListener('click', function(){
    ...
    let URL = "http://localhost/TW-Project/api/users/getuser/" + sessionStorage.getItem('id');
    let URL2 = "http://localhost/TW-Project/api/progress/getprogress/";
    fetch(URL, {
        method : 'GET',
        headers : new Headers({
            "Accept": "application/json"
        ...
        fetch(URL2 + name, {
            ...
            xhr.open('POST', './api/progress/addprogress');
            ...
            sessionStorage.setItem('questionsAnswered', 0);
                ...
                let URL3 = "http://localhost/TW-Project/api/answers/getanswers";
                fetch(URL3, {
                    method : 'GET',
                    headers : new Headers({
                        "Accept": "application/json"
         ...
         let anotherURL = "http://localhost/TW-Project/api/progress/getprogress/" + sessionStorage.getItem('name');
         fetch(anotherURL, {
            method : 'GET',
            headers : new Headers({
                "Accept": "application/json"
...
returner.addEventListener('click', function(){
    ...
    xhr.open('PUT', './api/progress/addprogress');
    xhr.setRequestHeader("Content-type", "application/json");
    console.log(array);
    ...
    if(sessionStorage.getItem('finished') != null){
        fetch("http://localhost/TW-Project/api/leaderboard/getleaderboard", {
            method : 'GET',
            headers : new Headers({
                "Accept": "application/json"
            }),
            ...
            if(found == "no"){
                fetch("http://localhost/TW-Project/api/progress/getprogress/" + sessionStorage.getItem('name'), {
                     method : 'GET',
                     headers : new Headers({
                    "Accept": "application/json"
                     }),
                    ...
                    const xhr = new XMLHttpRequest();
                    xhr.open('POST', './api/leaderboard/addleaderboard');
                    xhr.setRequestHeader("Content-type", "application/json");
                    console.log(array);
                    xhr.send(JSON.stringify(array));
                })
